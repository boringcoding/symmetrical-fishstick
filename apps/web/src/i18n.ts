...
const en: Dict = {
  ...
  // fortune
  fortuneTitle: 'Your fortune today',
  fortuneSub: 'Born under the moon — discover what today holds for you.',
  whenBorn: 'When were you born?',
  seeFortune: 'See my fortune ✨',
  luck: 'Luck',
  loveScore: 'Love',
  moneyScore: 'Money',
  healthScore: 'Health',
  ...
  yearOfThe: 'Year of the',
  compatibility: 'Love match 💞',
  compatTitle: 'Are you a match?',
  yourSign: 'You',
  theirSign: 'Them',
  theirBirth: "Their birth date",
  checkMatch: 'Check our match 💕',
  tryAgain: 'Try another',
  fullCalendar: 'Open full lunar calendar →',
  retake: 'Change date',
  shareFortune: 'Share my fortune',
};
...
const km: Dict = {
  ...
  // fortune
  fortuneTitle: 'រាសីអ្នកថ្ងៃនេះ',
  fortuneSub: 'កើតក្រោមពន្លឺច័ន្ទ — មកមើលថាថ្ងៃនេះមានអ្វីសម្រាប់អ្នក។',
  whenBorn: 'អ្នកកើតថ្ងៃណា?',
  seeFortune: 'មើលរាសីខ្ញុំ ✨',
  luck: 'សំណាង',
  loveScore: 'ស្នេហា',
  moneyScore: 'លុយ',
  healthScore: 'សុខភាព',
  luckyNumber: 'លេខសំណាង',
  luckyColor: 'ពណ៌សំណាង',
  yearOfThe: 'ឆ្នាំ',
  compatibility: 'គូស្នេហ៍ 💞',
  compatTitle: 'អ្នកទាំងពីរត្រូវគ្នាទេ?',
  yourSign: 'អ្នក',
  theirSign: 'គេ',
  theirBirth: 'ថ្ងៃកំណើតរបស់គេ',
  checkMatch: 'ពិនិត្យគូយើង 💕',
  tryAgain: 'សាកម្នាក់ទៀត',
  fullCalendar: 'បើកប្រតិទិនច័ន្ទពេញ →',
  retake: 'ប្ដូរថ្ងៃ',
  shareFortune: 'ចែករំលែករាសីខ្ញុំ',
};
